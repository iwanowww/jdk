...
#define inc_counter_np(counter) \
  ...
  address generate_catch_exception() {
    ...
    __ jump(RuntimeAddress(StubRoutines::_call_stub_return_address), noreg /*rscratch*/); // stub
  ...
  address generate_verify_oop() {
    ...
    __ call(RuntimeAddress(CAST_FROM_FN_PTR(address, MacroAssembler::debug64)), rscratch1);
    __ hlt();
    return start;
  }
  ...
  void array_overlap_test(address no_overlap_target, Label* NOLp, Address::ScaleFactor sf) {
    ...
    if (NOLp == NULL) {
      ExternalAddress no_overlap(no_overlap_target); // stub
      __ jump_cc(Assembler::belowEqual, no_overlap, noreg /*rscratch*/);
      __ cmpptr(to, end_from);
      __ jump_cc(Assembler::aboveEqual, no_overlap, noreg /*rscratch*/);
    } else {
 ...
 // Side Effects:
  ...
  address generate_unsafe_copy(const char *name,
    ...
    __ jump_cc(Assembler::notZero, RuntimeAddress(byte_copy_entry), noreg /*rscratch*/); // stub

    __ BIND(L_short_aligned);
    __ shrptr(size, LogBytesPerShort); // size => short_count
    __ jump(RuntimeAddress(short_copy_entry), noreg /*rscratch*/); // stub

    __ BIND(L_int_aligned);
    __ shrptr(size, LogBytesPerInt); // size => int_count
    __ jump(RuntimeAddress(int_copy_entry), noreg /*rscratch*/); // stub

    __ BIND(L_long_aligned);
    __ shrptr(size, LogBytesPerLong); // size => qword_count
    __ jump(RuntimeAddress(long_copy_entry), noreg /*rscratch*/); // stub
  ...
  address generate_generic_copy(const char *name,
    ...
    __ jump(RuntimeAddress(byte_copy_entry), noreg /*rscratch*/); // stub
  ...
  __ BIND(L_copy_longs);
    ...
    __ movl2ptr(count, r11_length); // length
    __ jump(RuntimeAddress(long_copy_entry), noreg /*rscratch*/); // strub
  ...
  __ BIND(L_plain_copy);
    ...
    __ pop(rklass_tmp); // Restore callee-save rdi
#endif
    __ jump(RuntimeAddress(oop_copy_entry), noreg /*rscratch*/); // stub
  ...
  __ BIND(L_checkcast_copy);
    // live at this point:  r10_src_klass, r11_length, rax (dst_klass)
    {
      ...
      __ jump(RuntimeAddress(checkcast_copy_entry), noreg /*rscratch*/); // stub
    }
  ...
  void load_key(XMMRegister xmmdst, Register key, int offset, XMMRegister xmm_shuf_mask = xnoreg) {
    ...
    if (xmm_shuf_mask != xnoreg) {
      ...
      __ pshufb(xmmdst, __ as_Address(ExternalAddress(StubRoutines::x86::key_shuffle_mask_addr()))); // stub
    }
  }
  ...
  address generate_aescrypt_encryptBlock() {
    ...
    __ movdqu(xmm_key_shuf_mask, __ as_Address(ExternalAddress(StubRoutines::x86::key_shuffle_mask_addr()))); // stub
  ...
  address generate_aescrypt_decryptBlock() {
    ...
    __ movdqu(xmm_key_shuf_mask, __ as_Address(ExternalAddress(StubRoutines::x86::key_shuffle_mask_addr())));
...
// Align stack
 ...
 // Vector AES Counter implementation
  ...
  address generate_counterMode_AESCrypt_Parallel() {
    ...
    __ movdqu(xmm_counter_shuf_mask, ExternalAddress(StubRoutines::x86::counter_shuffle_mask_addr()), noreg);
    ...
    __ movdqu(xmm_key_shuf_mask, ExternalAddress(StubRoutines::x86::key_shuffle_mask_addr()), noreg);
    __ movl(rbx, Address(key, arrayOopDesc::length_offset_in_bytes() - arrayOopDesc::base_offset_in_bytes(T_INT)));
    __ cmpl(rbx, 52);
...
void ev_load_key(XMMRegister xmmdst, Register key, int offset, XMMRegister xmm_shuf_mask = xnoreg) {
  ...
  if (xmm_shuf_mask != xnoreg) {
    ...
    __ pshufb(xmmdst, __ as_Address(ExternalAddress(StubRoutines::x86::key_shuffle_mask_addr())));
  }
...
address generate_avx_ghash_processBlocks() {
  ...
  address generate_ghash_processBlocks() {
    ...
    __ movdqu(xmm_temp10, __ as_Address(ExternalAddress(StubRoutines::x86::ghash_long_swap_mask_addr())));
    ...
    __ pshufb(xmm_temp2, __ as_Address(ExternalAddress(StubRoutines::x86::ghash_byte_swap_mask_addr())));
  ...
  address generate_base64_encodeBlock()
  {
    ...
    if (VM_Version::supports_avx512_vbmi()) {
      ...
      __ evmovdquq(xmm3, ExternalAddress(StubRoutines::x86::base64_shuffle_addr()), Assembler::AVX_512bit, noreg);
    ...
    if (VM_Version::supports_avx2()
      ...
      */
      ...
      __ vmovdqu(xmm9, ExternalAddress(StubRoutines::x86::base64_avx2_shuffle_addr()), noreg);
      // 6-bit mask for 2nd and 4th (and multiples) 6-bit values
      __ movl(rax, 0x0fc0fc00);
      __ vmovdqu(xmm1, ExternalAddress(StubRoutines::x86::base64_avx2_input_mask_addr()), noreg);
...
// private void decodeBlock(byte[] src, int sp, int sl, byte[] dst, int dp, boolean isURL, isMIME) {
  address generate_base64_decodeBlock() {
    ...
    if(VM_Version::supports_avx512_vbmi() &&
      ...
      __ evmovdquq(lookup_lo, ExternalAddress(StubRoutines::x86::base64_vbmi_lookup_lo_addr()), Assembler::AVX_512bit, noreg);
      __ evmovdquq(lookup_hi, ExternalAddress(StubRoutines::x86::base64_vbmi_lookup_hi_addr()), Assembler::AVX_512bit, noreg);
      ...
      __ BIND(L_processdata);
      __ evmovdquq(join01, ExternalAddress(StubRoutines::x86::base64_vbmi_join_0_1_addr()), Assembler::AVX_512bit, noreg);
      __ evmovdquq(join12, ExternalAddress(StubRoutines::x86::base64_vbmi_join_1_2_addr()), Assembler::AVX_512bit, noreg);
      __ evmovdquq(join23, ExternalAddress(StubRoutines::x86::base64_vbmi_join_2_3_addr()), Assembler::AVX_512bit, noreg);
      ...
      __ evmovdquq(pack24bits, ExternalAddress(StubRoutines::x86::base64_vbmi_pack_vec_addr()), Assembler::AVX_512bit, noreg);
      ...
      __ BIND(L_loadURL);
      __ evmovdquq(lookup_lo, ExternalAddress(StubRoutines::x86::base64_vbmi_lookup_lo_url_addr()), Assembler::AVX_512bit, noreg);
      __ evmovdquq(lookup_hi, ExternalAddress(StubRoutines::x86::base64_vbmi_lookup_hi_url_addr()), Assembler::AVX_512bit, noreg);
      __ jmp(L_continue);
...
#define __ masm->
  ...
  address generate_throw_exception(const char* name,
    ...
    __ call(RuntimeAddress(runtime_entry), rscratch1);
...
OopMap* continuation_enter_setup(MacroAssembler* masm, int& stack_slots) {
  ...
  __ subptr(rsp, ContinuationEntry::size());
