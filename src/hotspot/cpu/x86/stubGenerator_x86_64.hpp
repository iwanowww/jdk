...
class StubGenerator: public StubCodeGenerator {
 private:
  ...
  void gfmul_avx512(XMMRegister ghash, XMMRegister hkey, Register rscratch);
  ...
  void aesecb_encrypt(Register source_addr, Register dest_addr, Register key, Register len, Register rscratch);
  ...
  void inc_counter_np_(int& counter) PRODUCT_RETURN;
  ...
  //    Rtmp  -  scratch
  //
  void assert_clean_int(Register Rint, Register Rtmp) NOT_DEBUG_RETURN;
 ...
 // Side Effects:
  ...
  // CBC/AES Decrypt which does 4 blocks in a loop at a time to hide instruction latency.
  ...
  static address KEY_SHUFFLE_MASK;

  static address GHASH_LONG_SWAP_MASK; // byte swap x86 long array
  static address GHASH_BYTE_SWAP_MASK; // byte swap x86 byte array
