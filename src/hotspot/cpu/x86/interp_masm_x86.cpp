...
void InterpreterMacroAssembler::jump_to_entry(address entry) {
  ...
  jump(RuntimeAddress(entry), rscratch1);
}
...
void InterpreterMacroAssembler::push_l(Register r) {
  ...
  movptr(Address(rsp, Interpreter::expr_offset_in_bytes(1)), NULL_WORD, rscratch1);
}
  ...
  if (UseHeavyMonitors) {
    ...
    if (PrintBiasedLockingStatistics) {
      cond_inc32(Assembler::zero,
                 ExternalAddress((address) BiasedLocking::fast_path_entry_count_addr()), rscratch1);
    }
