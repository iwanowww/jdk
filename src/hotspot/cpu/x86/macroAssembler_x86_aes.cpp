...
void MacroAssembler::ev_load_key(XMMRegister xmmdst, Register key, int offset, XMMRegister xmm_shuf_mask) {
    ...
    if (xmm_shuf_mask != xnoreg) {
       ...
       pshufb(xmmdst, ExternalAddress(StubRoutines::x86::key_shuffle_mask_addr()), noreg);
    }
...
void MacroAssembler::aesecb_encrypt(Register src_addr, Register dest_addr, Register key, Register len) {
    ...
    movdqu(xmm_key_shuf_mask, ExternalAddress(StubRoutines::x86::key_shuffle_mask_addr()), noreg);
...
void MacroAssembler::generateHtbl_one_block(Register htbl) {
    ...
    movdqu(xmm4, ExternalAddress(StubRoutines::x86::ghash_shufflemask_addr()), noreg);
    vpshufb(xmm3, xmm3, xmm4, Assembler::AVX_128bit);
    movl(rax, 0xff00);
    movdl(xmm4, rax);
    vpshufb(xmm4, xmm4, xmm3, Assembler::AVX_128bit);
    movdqu(xmm5, ExternalAddress(StubRoutines::x86::ghash_polynomial_addr()), noreg);
...
void MacroAssembler::avx_ghash(Register input_state, Register htbl,
    ...
    bind(BEGIN_PROCESS);
    movdqu(lswap_mask, ExternalAddress(StubRoutines::x86::ghash_long_swap_mask_addr()), noreg);
    ...
    subl(blocks, 8);
    movdqu(bswap_mask, ExternalAddress(StubRoutines::x86::ghash_byte_swap_mask_addr()), noreg);
...
void MacroAssembler::aesctr_encrypt(Register src_addr, Register dest_addr, Register key, Register counter,
    ...
    // load lbswap mask
    evmovdquq(xmm16, ExternalAddress(StubRoutines::x86::counter_mask_addr()), Assembler::AVX_512bit, noreg);
    ...
    vpaddd(xmm8,  xmm8,  ExternalAddress(StubRoutines::x86::counter_mask_addr() +  64), Assembler::AVX_512bit, noreg);//linc0
    vpaddd(xmm9,  xmm8,  ExternalAddress(StubRoutines::x86::counter_mask_addr() + 128), Assembler::AVX_512bit, noreg);//linc4(rip)
    vpaddd(xmm10, xmm9,  ExternalAddress(StubRoutines::x86::counter_mask_addr() + 128), Assembler::AVX_512bit, noreg);//Linc4(rip)
    vpaddd(xmm11, xmm10, ExternalAddress(StubRoutines::x86::counter_mask_addr() + 128), Assembler::AVX_512bit, noreg);//Linc4(rip)
    vpaddd(xmm12, xmm11, ExternalAddress(StubRoutines::x86::counter_mask_addr() + 128), Assembler::AVX_512bit, noreg);//Linc4(rip)
    vpaddd(xmm13, xmm12, ExternalAddress(StubRoutines::x86::counter_mask_addr() + 128), Assembler::AVX_512bit, noreg);//Linc4(rip)
    vpaddd(xmm14, xmm13, ExternalAddress(StubRoutines::x86::counter_mask_addr() + 128), Assembler::AVX_512bit, noreg);//Linc4(rip)
    vpaddd(xmm15, xmm14, ExternalAddress(StubRoutines::x86::counter_mask_addr() + 128), Assembler::AVX_512bit, noreg);//Linc4(rip)

    // load linc32 mask in zmm register.linc32 increments counter by 32
    evmovdquq(xmm19, ExternalAddress(StubRoutines::x86::counter_mask_addr() + 256), Assembler::AVX_512bit, noreg);//Linc32

    // xmm31 contains the key shuffle mask.
    movdqu(xmm31, ExternalAddress(StubRoutines::x86::key_shuffle_mask_addr()), noreg);
    ...
    evmovdquq(xmm19, ExternalAddress(StubRoutines::x86::counter_mask_addr() + 80), Assembler::AVX_128bit, noreg);
    jmp(REMAINDER_LOOP);
    ...
    evmovdquq(xmm19, ExternalAddress(StubRoutines::x86::counter_mask_addr() + 320), Assembler::AVX_512bit, noreg);//Linc16(rip)
    ...
    evmovdquq(xmm19, ExternalAddress(StubRoutines::x86::counter_mask_addr() + 80), Assembler::AVX_128bit, noreg);//Linc0 + 16(rip)
    jmp(REMAINDER_LOOP);
    ...
    evmovdquq(xmm19, ExternalAddress(StubRoutines::x86::counter_mask_addr() + 192), Assembler::AVX_512bit, noreg);//Linc8(rip)
    ...
    evmovdquq(xmm19, ExternalAddress(StubRoutines::x86::counter_mask_addr() + 128), Assembler::AVX_512bit, noreg);//Linc4(rip)
