...
void MacroAssembler::libm_sincos_huge(XMMRegister xmm0, XMMRegister xmm1, Register eax, Register ecx, Register edx, Register ebx, Register esi, Register edi, Register ebp, Register esp) {
  ...
  movl(eax, esi);
  andl(eax, 2147483647);
  andps(xmm1, ExternalAddress(L_2IL0FLOATPACKET_0), noreg /*rscratch*/);    //0xffffffffUL, 0x7fffffffUL, 0x00000000UL, 0x00000000UL
  shrl(esi, 31);
  ...
  bind(B1_4);
  movsd(xmm0, ExternalAddress(PI4_INV), noreg /*rscratch*/);    //0x6dc9c883UL, 0x3ff45f30UL
  mulsd(xmm0, xmm1);
