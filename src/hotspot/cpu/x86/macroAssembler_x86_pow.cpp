...
void MacroAssembler::fast_pow(XMMRegister xmm0, XMMRegister xmm1, XMMRegister xmm2, XMMRegister xmm3,
  ...
  subsd(xmm5, xmm2);
  movdqu(xmm4, ExternalAddress(16 + coeff), tmp2 /*rscratch*/);    //0x9f95985aUL, 0xbfb528dbUL, 0xb3841d2aUL, 0xbfd619b6UL
  movl(ecx, eax);
  sarl(eax, 31);
  addl(ecx, eax);
  xorl(eax, ecx);
  ...
  bsrl(eax, eax);
  unpcklpd(xmm5, xmm3);
  movdqu(xmm6, ExternalAddress(32 + coeff), tmp2 /*rscratch*/);    //0x518775e3UL, 0x3f9004f2UL, 0xac8349bbUL, 0x3fa76c9bUL
  addsd(xmm3, xmm5);
  andl(edx, 16760832);
  shrl(edx, 10);
  addpd(xmm5, Address(tmp4, edx, Address::times_1, -3648));
  movdqu(xmm0, ExternalAddress(48 + coeff), tmp2 /*rscratch*/);    //0x486ececcUL, 0x3fc4635eUL, 0x161bb241UL, 0xbf5dabe1UL
  pshufd(xmm2, xmm3, 68);
  mulsd(xmm3, xmm3);
  mulpd(xmm1, xmm2);
  mulpd(xmm4, xmm2);
  ...
  movdqu(xmm3, ExternalAddress(16 + e_coeff), tmp2 /*rscratch*/);    //0x6fba4e77UL, 0x3f83b2abUL, 0xff82c58fUL, 0x3fcebfbdUL
  shll(ecx, 12);
  xorl(ecx, tmp1);
  andl(rcx, -1048576);
  movdq(xmm6, rcx);
...
void MacroAssembler::fast_pow(XMMRegister xmm0, XMMRegister xmm1, XMMRegister xmm2, XMMRegister xmm3, XMMRegister xmm4, XMMRegister xmm5, XMMRegister xmm6, XMMRegister xmm7, Register eax, Register ecx, Register edx, Register tmp) {
  ...
  // Special case: pow(x, 2.0) => x * x
  ucomisd(xmm1, ExternalAddress(DOUBLE2), noreg);
  ...
  bind(L_NOT_DOUBLE2);
  // Special case: pow(x, 0.5) => sqrt(x)
  ucomisd(xmm1, ExternalAddress(DOUBLE0DOT5), noreg); // For pow(x, y), check whether y == 0.5
  jccb(Assembler::notEqual, L_NOT_DOUBLE0DOT5);
  jccb(Assembler::parity, L_NOT_DOUBLE0DOT5);
  ucomisd(xmm0, ExternalAddress(DOUBLE0), noreg);
