...
void MacroAssembler::fast_pow(XMMRegister xmm0, XMMRegister xmm1, XMMRegister xmm2, XMMRegister xmm3, XMMRegister xmm4, XMMRegister xmm5, XMMRegister xmm6, XMMRegister xmm7, Register eax, Register ecx, Register edx, Register tmp1, Register tmp2, Register tmp3, Register tmp4) {
  ...
  movdq(tmp1, xmm1);
  cmp64(tmp1, ExternalAddress(DOUBLE2), rscratch1);
  ...
  xorl(ecx, edx);
  por(xmm0, xmm2);
  movdqu(xmm6, ExternalAddress(HIGHSIGMASK), rscratch1);    //0x00000000UL, 0xfffff800UL, 0x00000000UL, 0xfffff800UL
  psrlq(xmm0, 27);
  movq(xmm2, ExternalAddress(LOG2_E), rscratch1);    //0x00000000UL, 0x3ff72000UL, 0x161bb241UL, 0xbf5dabe1UL
  psrld(xmm0, 2);
  addl(ecx, 16);
  bsrl(ecx, ecx);
  rcpps(xmm0, xmm0);
  ...
  mulsd(xmm3, xmm0);
  movdqu(xmm1, ExternalAddress(coeff), rscratch1);    //0x6dc96112UL, 0xbf836578UL, 0xee241472UL, 0xbf9b0301UL
  lea(tmp4, ExternalAddress(L_tbl));
  subsd(xmm5, xmm2);
  movdqu(xmm4, ExternalAddress(16 + coeff), rscratch1);    //0x9f95985aUL, 0xbfb528dbUL, 0xb3841d2aUL, 0xbfd619b6UL
  movl(ecx, eax);
  sarl(eax, 31);
  addl(ecx, eax);
  xorl(eax, ecx);
  ...
  bsrl(eax, eax);
  unpcklpd(xmm5, xmm3);
  movdqu(xmm6, ExternalAddress(32 + coeff), rscratch1);    //0x518775e3UL, 0x3f9004f2UL, 0xac8349bbUL, 0x3fa76c9bUL
  addsd(xmm3, xmm5);
  andl(edx, 16760832);
  shrl(edx, 10);
  addpd(xmm5, Address(tmp4, edx, Address::times_1, -3648));
  movdqu(xmm0, ExternalAddress(48 + coeff), rscratch1);    //0x486ececcUL, 0x3fc4635eUL, 0x161bb241UL, 0xbf5dabe1UL
  pshufd(xmm2, xmm3, 68);
  mulsd(xmm3, xmm3);
  mulpd(xmm1, xmm2);
  mulpd(xmm4, xmm2);
  ...
  movq(xmm4, ExternalAddress(HIGHMASK_Y), rscratch1);    //0x00000000UL, 0xfffffff8UL, 0x00000000UL, 0xffffffffUL
  mulpd(xmm6, xmm2);
  pshufd(xmm3, xmm3, 68);
  mulpd(xmm0, xmm2);
  shll(eax, 4);
  ...
  addsd(xmm4, xmm1);
  mulsd(xmm2, xmm0);
  movdqu(xmm7, ExternalAddress(e_coeff), rscratch1);    //0xe78a6731UL, 0x3f55d87fUL, 0xd704a0c0UL, 0x3fac6b08UL
  movdqu(xmm3, ExternalAddress(16 + e_coeff), rscratch1);    //0x6fba4e77UL, 0x3f83b2abUL, 0xff82c58fUL, 0x3fcebfbdUL
  shll(ecx, 12);
  xorl(ecx, tmp1);
  andl(rcx, -1048576);
  movdq(xmm6, rcx);
  ...
  addsd(xmm0, xmm7);
  movq(xmm2, ExternalAddress(HALFMASK), rscratch1);    //0xf8000000UL, 0xffffffffUL, 0xf8000000UL, 0xffffffffUL
  addpd(xmm3, xmm0);
  xorpd(xmm6, xmm6);
  movl(eax, 17080);
  pinsrw(xmm6, eax, 3);
  ...
  lea(tmp4, ExternalAddress(T_exp));
  addsd(xmm2, xmm1);
  movdqu(xmm7, ExternalAddress(e_coeff +  0), rscratch1);    //0xe78a6731UL, 0x3f55d87fUL, 0xd704a0c0UL, 0x3fac6b08UL
  movdqu(xmm3, ExternalAddress(e_coeff + 16), rscratch1);    //0x6fba4e77UL, 0x3f83b2abUL, 0xff82c58fUL, 0x3fcebfbdUL
  subsd(xmm4, xmm6);
  pextrw(edx, xmm6, 3);
  movl(ecx, eax);
  andl(eax, 255);
  ...
  xorl(ecx, tmp1);
  movdl(xmm6, ecx);
  movq(xmm1, ExternalAddress(e_coeff + 32), rscratch1);    //0xfefa39efUL, 0x3fe62e42UL, 0x00000000UL, 0x00000000UL
  andl(edx, 32767);
  cmpl(edx, 16529);
  ...
  movq(xmm4, ExternalAddress(coeff_h), rscratch1);    //0x00000000UL, 0xbfd61a00UL, 0x00000000UL, 0xbf5dabe1UL
  mulsd(xmm3, xmm0);
  movq(xmm6, ExternalAddress(coeff_h), rscratch1);    //0x00000000UL, 0xbfd61a00UL, 0x00000000UL, 0xbf5dabe1UL
  subsd(xmm5, xmm2);
  movq(xmm1, ExternalAddress(coeff_h + 8), rscratch1);    //0x00000000UL, 0xbf5dabe1UL
  pshufd(xmm2, xmm3, 68);
  unpcklpd(xmm5, xmm3);
  addsd(xmm3, xmm5);
  movq(xmm0, ExternalAddress(coeff_h + 8), rscratch1);    //0x00000000UL, 0xbf5dabe1UL
  andl(edx, 16760832);
  shrl(edx, 10);
  ...
  addsd(xmm7, xmm2);
  addsd(xmm4, xmm0);
  movdqu(xmm0, ExternalAddress(coeff), rscratch1);    //0x6dc96112UL, 0xbf836578UL, 0xee241472UL, 0xbf9b0301UL
  subsd(xmm5, xmm7);
  addsd(xmm6, xmm4);
  movdqu(xmm4, xmm7);
  addsd(xmm5, xmm2);
  addsd(xmm7, xmm1);
  movdqu(xmm2, ExternalAddress(coeff + 64), rscratch1);    //0x486ececcUL, 0x3fc4635eUL, 0x161bb241UL, 0xbf5dabe1UL
  subsd(xmm4, xmm7);
  addsd(xmm6, xmm5);
  addsd(xmm4, xmm1);
  ...
  subsd(xmm1, xmm7);
  addsd(xmm1, xmm5);
  movdqu(xmm5, ExternalAddress(coeff + 80), rscratch1);    //0x9f95985aUL, 0xbfb528dbUL, 0xf8b5787dUL, 0x3ef2531eUL
  pshufd(xmm3, xmm3, 68);
  addsd(xmm6, xmm4);
  addsd(xmm6, xmm1);
  movdqu(xmm1, ExternalAddress(coeff + 32), rscratch1);    //0x9f95985aUL, 0xbfb528dbUL, 0xb3841d2aUL, 0xbfd619b6UL
  mulpd(xmm0, xmm3);
  mulpd(xmm2, xmm3);
  pshufd(xmm4, xmm3, 68);
  mulpd(xmm3, xmm3);
  ...
  addpd(xmm5, xmm2);
  mulsd(xmm4, xmm3);
  movq(xmm2, ExternalAddress(HIGHMASK_LOG_X), rscratch1);    //0xf8000000UL, 0xffffffffUL, 0x00000000UL, 0xfffff800UL
  mulpd(xmm3, xmm3);
  movq(xmm1, Address(rsp, 16));
  movw(ecx, Address(rsp, 22));
  mulpd(xmm0, xmm4);
  ...
  mulpd(xmm5, xmm4);
  mulpd(xmm0, xmm3);
  movq(xmm4, ExternalAddress(HIGHMASK_Y + 8), rscratch1);    //0x00000000UL, 0xffffffffUL
  pand(xmm2, xmm7);
  addsd(xmm5, xmm6);
  subsd(xmm7, xmm2);
  addpd(xmm5, xmm0);
  ...
  lea(tmp4, ExternalAddress(T_exp));
  movdqu(xmm3, ExternalAddress(e_coeff + 16), rscratch1);    //0x6fba4e77UL, 0x3f83b2abUL, 0xff82c58fUL, 0x3fcebfbdUL
  movq(xmm2, ExternalAddress(e_coeff + 32), rscratch1);    //0xfefa39efUL, 0x3fe62e42UL, 0x00000000UL, 0x00000000UL
  subsd(xmm4, xmm6);
  movl(ecx, edx);
  andl(edx, 255);
  addl(edx, edx);
