...
const char* Register::name(Register r)  {
  static const char *const names[number_of_declared_registers + 1] = {
    ...
    "rthread", "rfp", "lr", "r31_sp", "zr", "sp", "noreg"
  };
  return names[encoding(r)];
}

const char* FloatRegister::name(FloatRegister fr)  {
  static const char *const names[number_of_registers + 1] = {
