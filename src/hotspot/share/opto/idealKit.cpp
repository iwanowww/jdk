...
Node* IdealKit::make_leaf_call(const TypeFunc *slow_call_type,
  ...
  // Slow-path leaf call
  CallNode *call =  (CallNode*)new CallLeafNode(C, slow_call_type, slow_call, leaf_name, adr_type);
...
void IdealKit::make_leaf_call_no_fp(const TypeFunc *slow_call_type,
  ...
  // Slow-path leaf call
  CallNode *call =  (CallNode*)new CallLeafNoFPNode(C, slow_call_type, slow_call, leaf_name, adr_type);
