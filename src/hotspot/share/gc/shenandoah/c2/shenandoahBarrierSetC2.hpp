...
public:
  ...
  virtual bool strip_mined_loops_expanded(LoopOptsMode mode) const { return mode == PostLoopOptsShenandoahExpand; }
  virtual bool is_gc_specific_loop_opts_pass(LoopOptsMode mode) const { return mode == PostLoopOptsShenandoahExpand; }
