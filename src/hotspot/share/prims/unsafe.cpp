...
UNSAFE_ENTRY(jlong, Unsafe_GetPrimitiveBitsMO(JNIEnv *env, jobject unsafe,
...
UNSAFE_ENTRY(void, Unsafe_PutPrimitiveBitsMO(JNIEnv *env, jobject unsafe,
                                                    jbyte memory_order, jbyte basic_type,
...
UNSAFE_ENTRY(jlong, Unsafe_CompareAndExchangePrimitiveBitsMO(JNIEnv *env, jobject unsafe,
                                                                    jbyte memory_order, jbyte basic_type,
                                                                    jobject obj, jlong offset,
                                                                    jlong e, jlong x)) {
  assert(vmIntrinsics::is_valid_memory_order(memory_order),
...
UNSAFE_ENTRY(jboolean, Unsafe_CompareAndSetPrimitiveBitsMO(JNIEnv *env, jobject unsafe,
                                                                  jbyte memory_order, jbyte basic_type,
