...
#define VM_INTRINSICS_DO(do_intrinsic, do_class, do_name, do_signature, do_alias)                                       \
  ...
  do_intrinsic(_getCharStringU,           java_lang_StringUTF16, getCharStringU_name, getCharStringU_signature,  F_S)   \
   do_name(     getCharStringU_name,                             "getChar")                                             \
   do_signature(getCharStringU_signature,                        "([BI)C")                                              \
  do_intrinsic(_putCharStringU,           java_lang_StringUTF16, putCharStringU_name, putCharStringU_signature,  F_S)   \
   do_name(     putCharStringU_name,                             "putChar")                                             \
  ...
  do_intrinsic(_getFlatValue, jdk_internal_misc_Unsafe, getFlatValue_name, getFlatValue_signature, F_RN)                \
   do_name(     getFlatValue_name,      "getFlatValue")                                                                 \
  ...
  do_intrinsic(_putFlatValue, jdk_internal_misc_Unsafe, putFlatValue_name, putFlatValue_signature, F_RN)                \
   do_name(     putFlatValue_name,      "putFlatValue")                                                                 \
